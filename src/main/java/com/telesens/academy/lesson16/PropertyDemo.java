...
import HomeTask.lesson15.Subscriber;
...
//        OutputStreamWriter osw = new OutputStreamWriter(os);
        ...
        InputStream resourceStream = PropertyDemo.class.getClassLoader().getResourceAsStream(PROP_NAME);
        try {
